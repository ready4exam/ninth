  ...
  "9": {
    "Science": {
      "Physics": [
        ...
        { "id": "force_and_laws_of_motion", "title": "Chapter 8: Force and Laws of Motion" },
        { "id": "gravitation", "title": "Chapter 9: Gravitation" },
        { "id": "work_and_energy", "title": "Chapter 10: Work and Energy" },
        { "id": "sound", "title": "Chapter 11: Sound" }
      ],
      "Chemistry": [
        { "id": "matter_in_our_surroundings", "title": "Chapter 1: Matter in Our Surroundings" },
        { "id": "is_matter_around_us_pure", "title": "Chapter 2: Is Matter Around Us Pure" },
        { "id": "atoms_and_molecules", "title": "Chapter 3: Atoms and Molecules" },
        { "id": "structure_of_the_atom", "title": "Chapter 4: Structure of the Atom" }
      ],
      "Biology": [
    ...
    "Social_Science": {
      ...
      "Geography": [
        { "id": "india_size_and_location", "title": "Chapter 1: India - Size and Location" },
        { "id": "physical_features_of_india", "title": "Chapter 2: Physical Features of India" },
        { "id": "drainage", "title": "Chapter 3: Drainage" },
        { "id": "climate", "title": "Chapter 4: Climate" },
        { "id": "natural_vegetation_and_wildlife", "title": "Chapter 5: Natural Vegetation and Wildlife" },
        { "id": "population", "title": "Chapter 6: Population" }
      ],
      "Political_Science": [
        { "id": "what_is_democracy_why_democracy", "title": "Chapter 1: What is Democracy? Why Democracy?" },
        { "id": "constitutional_design", "title": "Chapter 2: Constitutional Design" },
        { "id": "electoral_politics", "title": "Chapter 3: Electoral Politics" },
        { "id": "working_of_institutions", "title": "Chapter 4: Working of Institutions" },
        { "id": "democratic_rights", "title": "Chapter 5: Democratic Rights" }
      ],
      "Economics": [
        { "id": "story_of_village_palampur", "title": "Chapter 1: The Story of Village Palampur" },
        { "id": "people_as_resource", "title": "Chapter 2: People as Resource" },
